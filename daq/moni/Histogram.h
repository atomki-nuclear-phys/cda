...
public:
   ...
   Histogram(QWidget* parent = 0, Qt::WindowFlags flags = Qt::WindowFlags());
...
protected:
   ...
   AxisBinning getLinearAxisBinning(double low, double up, double alength,
                                    int tdist) const;
   /// Function determining the visual binning for a logarithmic axis
   AxisBinning getLogarithmicAxisBinning(double low, double up, double alength,
                                         int tdist) const;
