...
// $Id$
#ifndef CDA_DEVICES_V785_GUI_H
#define CDA_DEVICES_V785_GUI_H
...
namespace v785 {
   ...
   /// Class used to interactively configure the data collection from a V785
   ///
