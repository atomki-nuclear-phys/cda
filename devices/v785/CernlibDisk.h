...
// $Id$
#ifndef CDA_DEVICES_V785_CERNLIBDISK_H
#define CDA_DEVICES_V785_CERNLIBDISK_H
...
namespace v785 {
   ...
   /// Class writing the data read from a V785 to a HBOOK file
   ///
   /// This class is used by the cda-hbook-writer application to write CERNLIB
   /// hbook files with the data collected from a V785 device.
   ///
   ...
   class CernlibDisk : public virtual dev::ICernlibDisk,
      ...
      Q_DECLARE_TR_FUNCTIONS( v785::CernlibDisk )
...
#endif // CDA_DEVICES_V785_CERNLIBDISK_H
