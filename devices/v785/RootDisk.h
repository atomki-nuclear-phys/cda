...
// $Id$
#ifndef CDA_DEVICES_V785_ROOTDISK_H
#define CDA_DEVICES_V785_ROOTDISK_H
...
namespace v785 {
   ...
   /// Class writing the data read from a V785 device to a ROOT file
   ///
   ...
   class RootDisk : public virtual dev::IRootDisk,
      ...
      Q_DECLARE_TR_FUNCTIONS( v785::RootDisk )
...
#endif // CDA_DEVICES_V785_ROOTDISK_H
