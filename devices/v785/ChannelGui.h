...
// $Id$
#ifndef CDA_DEVICES_V785_CHANNELGUI_H
#define CDA_DEVICES_V785_CHANNELGUI_H
 ...
 *
 *         Each input channel of the V785 has the same properties
 *         that the user would want to change. These are the same
 *         properties that are stored in the v785::ChannelConfig
 *         class.
 *
...
#endif  // CDA_DEVICES_V785_CHANNELGUI_H
