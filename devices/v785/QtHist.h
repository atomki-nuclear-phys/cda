...
// $Id$
#ifndef CDA_DEVICES_V785_QTHIST_H
#define CDA_DEVICES_V785_QTHIST_H
...
namespace v785 {
   ...
   /// Class providing Qt-only monitoring for a V785 device
   ///
   /// This class is used to monitor the data taking of V785 devices in a way
   ...
   public:
      ...
      /// @name Function(s) reimplemented from v785::Device
      /// @{
...
#endif // CDA_DEVICES_V785_QTHIST_H
