...
Gui::Gui(QWidget* parent, Qt::WindowFlags flags)
    : dev::CaenVmeGui(parent, flags), m_logger("v785::Gui") {
   ...
   //
   m_topLabel.reset(new QLabel(tr("CAEN V785 32 Channel Multievent "
                                  "Peak Sensing ADC"),
                               m_scrollWidget.get()));
   ...
   m_deviceSettingsBox->setGeometry(QRect(130, 80, WIDGET_WIDTH - 150, 150));
