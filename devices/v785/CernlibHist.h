...
// $Id%
#ifndef CDA_DEVICES_V785_CERNLIBHIST_H
#define CDA_DEVICES_V785_CERNLIBHIST_H
...
namespace v785 {
   ...
   /// Class filling PAW monitoring histograms from a V785 device
   ///
   /// This class is used to create and fill monitoring histograms in PAW's
   /// common memory during data taking, from data collected from a V785 board.
   ///
   ...
   class CernlibHist : public virtual dev::ICernlibHist,
      ...
      Q_DECLARE_TR_FUNCTIONS( v785::CernlibHist )
...
#endif // CDA_DEVICES_V785_CERNLIBHIST_H
