...
Gui::Gui(QWidget* parent, Qt::WindowFlags flags)
    : dev::CaenVmeGui(parent, flags), m_logger("v792::Gui") {
   ...
   //
   m_topLabel.reset(new QLabel(tr("CAEN V792 32 Channel Multievent QDC"),
                               m_scrollWidget.get()));
   ...
   m_deviceSettingsBox->setGeometry(QRect(130, 80, WIDGET_WIDTH - 150, 175));
   ...
   m_zeroSuppressionEdit.reset(
       new QCheckBox("Zero suppression enabled", m_deviceSettingsBox.get()));
   ...
   m_overflowSuppressionEdit.reset(new QCheckBox("Overflow suppression enabled",
   ...
   m_validSuppressionEdit.reset(
       new QCheckBox("Valid suppression enabled", m_deviceSettingsBox.get()));
   ...
   m_pedestalLabel.reset(new QLabel(tr("Pedestal"), m_deviceSettingsBox.get()));
   ...
   connect(m_pedestalEdit.get(), SIGNAL(valueChanged(int)), this,
           SLOT(pedestalSlot(int)));
