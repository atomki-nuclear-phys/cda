...
// $Id$
#ifndef CDA_DEVICES_V792_CHANNELCONFIG_H
#define CDA_DEVICES_V792_CHANNELCONFIG_H
...
/**
 *  @short Class describing one channel of a V792 QDC module
 *
 *         Each channel of a V792 module has a number of properties.
...
class ChannelConfig : virtual public dev::IConfig {
   ...
   Q_DECLARE_TR_FUNCTIONS(v792::ChannelConfig)
...
#endif  // CDA_DEVICES_V792_CHANNELCONFIG_H
