...
// $Id$
#ifndef CDA_DEVICES_V792_DEVICE_H
#define CDA_DEVICES_V792_DEVICE_H
...
namespace v792 {
   ...
   /// Class holding the configuration of a V792 CAEN VME QDC
   ///
   /// This is used as the base class for all the other device classes in the
   /// plugin. Storing, writing, and reading the configuration of a V792
   /// device.
   ///
   ...
   class Device : public virtual dev::IDevice {
      ...
      Q_DECLARE_TR_FUNCTIONS( v792::Device )
...
#endif // CDA_DEVICES_V792_DEVICE_H
