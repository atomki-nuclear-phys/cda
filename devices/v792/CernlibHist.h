...
// $Id%
#ifndef CDA_DEVICES_V792_CERNLIBHIST_H
#define CDA_DEVICES_V792_CERNLIBHIST_H
...
/// Class filling PAW monitoring histograms from a V792 device
///
/// This class is used to create and fill monitoring histograms in PAW's
/// common memory during data taking, from data collected from a V792 board.
///
...
class CernlibHist : public virtual dev::ICernlibHist, public virtual Device {
   ...
   Q_DECLARE_TR_FUNCTIONS(v792::CernlibHist)
...
#endif  // CDA_DEVICES_V792_CERNLIBHIST_H
