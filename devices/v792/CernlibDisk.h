...
// $Id$
#ifndef CDA_DEVICES_V792_CERNLIBDISK_H
#define CDA_DEVICES_V792_CERNLIBDISK_H
...
/// Class writing the data read from a V792 to a HBOOK file
///
/// This class is used by the cda-hbook-writer application to write CERNLIB
/// hbook files with the data collected from a V792 device.
///
...
class CernlibDisk : public virtual dev::ICernlibDisk, public virtual Device {
   ...
   Q_DECLARE_TR_FUNCTIONS(v792::CernlibDisk)
...
#endif  // CDA_DEVICES_V792_CERNLIBDISK_H
