...
Readout::Readout() : Device(), m_logger("v792::Readout") {}

StatusCode Readout::initialize(const caen::VmeBus& bus) {

   // Open the connection to the hardware device:
   CHECK(m_vmeDevice.open(m_vmeAddress, caen::VmeDevice::DEV_V792A, bus));
   ...
   CHECK(m_vmeDevice.setAcquisitionMode(
       ...
       COMMON_STOP_ENABLE, EMPTY_ENABLE, COUNT_ALL_EVENTS));
