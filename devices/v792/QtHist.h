...
// $Id$
#ifndef CDA_DEVICES_V792_QTHIST_H
#define CDA_DEVICES_V792_QTHIST_H
...
namespace v792 {
   ...
   /// Class providing Qt-only monitoring for a V792 device
   ///
   /// This class is used to monitor the data taking of V792 devices in a way
   ...
   public:
      ...
      /// @name Function(s) reimplemented from v792::Device
      /// @{
...
#endif // CDA_DEVICES_V792_QTHIST_H
