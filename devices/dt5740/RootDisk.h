...
private:
   ...
   mutable std::vector<uint16_t> m_channelData[NUMBER_OF_GROUPS]
                                              [GroupConfig::CHANNELS_IN_GROUP];
   /// The reconstructed time values
   mutable double m_times[NUMBER_OF_GROUPS][GroupConfig::CHANNELS_IN_GROUP];
   /// The reconstructed energy values
   mutable double m_energies[NUMBER_OF_GROUPS][GroupConfig::CHANNELS_IN_GROUP];
