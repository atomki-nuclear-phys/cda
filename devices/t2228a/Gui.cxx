...
Gui::Gui(QWidget* parent, Qt::WindowFlags flags)
   ...
   //
   m_topLabel.reset(
       new QLabel(tr("LeCroy 2228A Octal Time-to-Digital Converter"), this));
   ...
   for (int i = 0; i < NUMBER_OF_SUBADDRESSES; ++i) {
      ...
      m_gchannels[i]->setGeometry(
          QRect(35, 100 + i * 25, ChannelGui::WIDTH, ChannelGui::HEIGHT));
...
void Gui::drawModule(QPainter& painter) const {
   ...
   painter.drawText(QRect(0, 0, 20, 15), Qt::AlignCenter, tr("TDC"));
