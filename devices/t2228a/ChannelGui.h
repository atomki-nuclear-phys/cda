...
// $Id$
#ifndef CDA_DEVICES_T2228A_CHANNELGUI_H
#define CDA_DEVICES_T2228A_CHANNELGUI_H
...
namespace t2228a {
    ...
    *
    *         Each input channel of the 2228A has the same properties
    *         that the user would want to change. These are the same
    *         properties that are stored in the t2228a::ChannelConfig
    *         class.
    *
...
#endif // CDA_DEVICES_T2228A_CHANNELGUI_H
