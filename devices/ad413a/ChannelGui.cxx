...
const int ChannelGui::WIDTH = 510;
 ...
 */
ChannelGui::ChannelGui(int subaddress, QWidget* parent, Qt::WindowFlags flags)
   ...
   //
   m_enabledEdit.reset(
       new QCheckBox(tr("%1. subaddress").arg(m_subaddress), this));
   ...
   connect(m_lldEdit.get(), SIGNAL(valueChanged(int)), this,
           SLOT(lldChangedSlot(int)));
...
void ChannelGui::enableChangedSlot(bool on) {
   ...
   if (on) {
      ...
      emit lldChanged(m_subaddress, m_lldEdit->value());
