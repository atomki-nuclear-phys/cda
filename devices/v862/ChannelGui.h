...
// $Id$
#ifndef CDA_DEVICES_V862_CHANNELGUI_H
#define CDA_DEVICES_V862_CHANNELGUI_H
...
namespace v862 {
    ...
    *
    *         Each input channel of the V862 has the same properties
    *         that the user would want to change. These are the same
    *         properties that are stored in the v862::ChannelConfig
    *         class.
    *
...
#endif // CDA_DEVICES_V862_CHANNELGUI_H
