...
// $Id$
#ifndef CDA_DEVICES_V862_CHANNELCONFIG_H
#define CDA_DEVICES_V862_CHANNELCONFIG_H
...
namespace v862 {
   ...
   /**
    *  @short Class describing one channel of a V862 QDC module
    *
    *         Each channel of a V862 module has a number of properties.
   ...
   class ChannelConfig : virtual public dev::IConfig {
      ...
      Q_DECLARE_TR_FUNCTIONS( v862::ChannelConfig )
...
#endif // CDA_DEVICES_V862_CHANNELCONFIG_H
