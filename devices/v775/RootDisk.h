...
// $Id$
#ifndef CDA_DEVICES_V775_ROOTDISK_H
#define CDA_DEVICES_V775_ROOTDISK_H
...
namespace v775 {
   ...
   /// Class writing the data read from a V775 device to a ROOT file
   ///
   ...
   class RootDisk : public virtual dev::IRootDisk,
      ...
      Q_DECLARE_TR_FUNCTIONS( v775::RootDisk )
...
#endif // CDA_DEVICES_V775_ROOTDISK_H
