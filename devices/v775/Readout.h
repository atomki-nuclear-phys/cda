...
// $Id$
#ifndef CDA_DEVICES_V775_READOUT_H
#define CDA_DEVICES_V775_READOUT_H
...
namespace v775 {
   ...
   /// Class responsible for communicating with the V775 hardware module
   ///
   /// This class is used by the readout application to configure the V775
   ...
   class Readout : public Device,
      ...
      Q_DECLARE_TR_FUNCTIONS( v775::Readout )
...
#endif // CDA_DEVICES_V775_READOUT_H
