...
// $Id$
#ifndef CDA_DEVICES_V775_CHANNELGUI_H
#define CDA_DEVICES_V775_CHANNELGUI_H
...
namespace v775 {
    ...
    *
    *         Each input channel of the V775 has the same properties
    *         that the user would want to change. These are the same
    *         properties that are stored in the v775::ChannelConfig
    *         class.
    *
...
#endif // CDA_DEVICES_V775_CHANNELGUI_H
