...
// $Id$
#ifndef CDA_DEVICES_V775_CERNLIBDISK_H
#define CDA_DEVICES_V775_CERNLIBDISK_H
...
namespace v775 {
   ...
   /// Class writing the data read from a V775 to a HBOOK file
   ///
   /// This class is used by the cda-hbook-writer application to write CERNLIB
   /// hbook files with the data collected from a V775 device.
   ///
   ...
   class CernlibDisk : public virtual dev::ICernlibDisk,
      ...
      Q_DECLARE_TR_FUNCTIONS( v775::CernlibDisk )
...
#endif // CDA_DEVICES_V775_CERNLIBDISK_H
