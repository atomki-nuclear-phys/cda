...
// Global variable(s):
msg::Logger   g_logger( "cda-root-writer" );
root::Crate* g_crate = 0;
root::FileWriter* g_fwriter = 0;
quint32 g_evcount = 0;
...
int main( int argc, char* argv[] ) {
   ...
   CmdArgStr evaddress( 'e', "evaddress", "address", "Address where to receive events",
                        CmdArg::isREQ );
   CmdArgStr output( 'o', "output", "filename", "Name of ROOT file",
                     CmdArg::isREQ );
   ...
   if( fileName.contains( "%1" ) ) {
      ...
      if( ! g_crate->initialize( fileName.arg( filecounter, ( int ) 3, ( int ) 10,
         ...
         g_logger << msg::DEBUG
                  << qApp->translate( "cda-root-writer",
                                      "Initialised ROOT file for data acquisition" )
                  << msg::endmsg;
      }
      //
