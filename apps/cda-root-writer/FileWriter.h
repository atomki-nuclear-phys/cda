...
// $Id$
#ifndef CDA_APPS_CDA_ROOT_WRITER_FILEWRITER_H
#define CDA_APPS_CDA_ROOT_WRITER_FILEWRITER_H
...
namespace root {
   ...
   public:
      /// Constructor
      FileWriter( ev::EventServer& evserver, Crate& crate,
                  QObject* parent = 0 );
   ...
   private:
      ...
      Crate& m_crate; ///< Pre-configured crate object
...
#endif // CDA_APPS_CDA_ROOT_WRITER_FILEWRITER_H
