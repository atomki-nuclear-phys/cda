...
//
#ifndef CDA_APPS_CDA_CAEN_DAQ_MAINWINDOW_H
#define CDA_APPS_CDA_CAEN_DAQ_MAINWINDOW_H
...
private:
   ...
   /// Widget controlling cda-caen-reader
   simple_daq::CaenReaderRunner m_caenReader;
...
#endif  // CDA_APPS_CDA_CAEN_DAQ_MAINWINDOW_H
