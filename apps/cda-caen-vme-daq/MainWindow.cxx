...
MainWindow::MainWindow(const QString& confFileName, msg::Level verbosity)
    : QMainWindow(),
      ...
      m_caenVmeReader{&m_centralWidget},
   ...
   m_layout.addWidget(&m_caenVmeReader, 0, 1);
   ...
   m_caenVmeReader.setEnabled(!confFileName.isEmpty());
   ...
   connect(&m_glomemWriter, SIGNAL(receiverRunning(bool, const QString&)),
           &m_caenVmeReader, SLOT(setWriterRunning(bool, const QString&)));
...
void MainWindow::removeStatReceiverSlot() {
   ...
   m_caenVmeReader.setStatServerAddress(false, m_statReceivers.currentText());
