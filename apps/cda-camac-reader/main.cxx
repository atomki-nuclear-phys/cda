...
int main(int argc, char* argv[]) {
   ...
   if (!g_crate->open()) {
      ...
      g_logger << msg::INFO
               << qApp->translate("cda-camac-reader", "Opened the CAMAC crate")
               << msg::endmsg;
   }
   ...
   //
   g_logger << msg::INFO
            << qApp->translate("cda-camac-reader", "CAMAC readout running...")
            << msg::endmsg;
...
void shutDown(int) {
   ...
   g_logger << msg::INFO
            ...
            << msg::endmsg;
   g_logger << msg::INFO
            << qApp->translate("cda-camac-reader", "Terminating application...")
            << msg::endmsg;
   exit(0);
