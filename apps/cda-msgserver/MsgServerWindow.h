...
private:
   ...
   QDockWidget*
       m_shownLinesDock;  ///< Dock widget for the maximum line modification

   QComboBox* m_minMsgLevelEdit;  ///< Minimum level of shown messages
   QDockWidget*
       m_minMsgLevelDock;  ///< Dock widget for the msg. level modifications
   ...
   QDockWidget*
       m_outputFileDock;  ///< Dock widget for the output file modifications

   QAction* m_quitAction;  ///< Action quiting the application

   QAction* m_showPortDock;        ///< Action handling the port dock visibility
   QAction* m_showShownLinesDock;  ///< Action handling the shown lines dock
                                   ///< visibility
   QAction* m_showOutputFileDock;  ///< Action handling the output file dock
                                   ///< visibility
   QAction*
       m_showMsgLevelDock;  ///< Action handling the msg. level dock visibility

   QAction* m_aboutQtAction;         ///< Action showing a window about Qt
   QAction* m_aboutCDAAction;        ///< Action showing a window about CDA
   QAction* m_aboutMsgServerAction;  ///< Action showing a window about this
                                     ///< application
