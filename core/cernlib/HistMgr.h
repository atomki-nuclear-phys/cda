...
public:
   ...
   int book_1d(const char* name, int channels, double lowerBound,
               double upperBound);
   /// Book a 2-dimensional histogram
   int book_2d(const char* name, int xchannels, double xlow, double xup,
   ...
   void fill_2d(int id, double xdata, double ydata, double weight = 1.0) const;
