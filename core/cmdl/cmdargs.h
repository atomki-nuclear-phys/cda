...
//-------------------------------------------------------------- Dummy Argument
   ...
   //
class CmdLineExport CmdArgDummy : public CmdArg {
public:
...
//-------------------------------------------------------------- Usage Argument
   ...
   //
class CmdLineExport CmdArgUsage : public CmdArg {
public:
   CmdArgUsage(char         optchar,
               const char * keyword,
               const char * description,
               std::ostream    * osp = (std::ostream *)0);   // cout is used if "osp" is NULL
...
//----------------------------------------------------------- Integer Arguments
   ...
   //
class CmdLineExport CmdArgIntCompiler : public CmdArg {
public:
   ...
   //
class CmdLineExport CmdArgInt : public CmdArgIntCompiler {
public:
...
//---------------------------------------------------- Floating-point Arguments
   ...
   //
class CmdLineExport CmdArgFloatCompiler : public CmdArg {
public:
   ...
   //
class CmdLineExport CmdArgFloat : public CmdArgFloatCompiler {
public:
...
//--------------------------------------------------------- Character Arguments
   ...
   //
class CmdLineExport CmdArgCharCompiler : public CmdArg {
public:
   ...
   //
class CmdLineExport CmdArgChar : public CmdArgCharCompiler {
public:
...
//------------------------------------------------------------ String Arguments
   ...
   //
class CmdLineExport CmdArgStrCompiler : public CmdArg {
public:
   ...
   //     }
   //
class CmdLineExport CmdArgStr : public CmdArgStrCompiler {
public:
...
class CmdLineExport CmdArgIntList : public CmdArgIntCompiler {
public:
...
class CmdLineExport CmdArgFloatList : public CmdArgFloatCompiler {
public:
...
class CmdLineExport CmdArgStrList : public CmdArgStrCompiler {
public:
...
//----------------------------------------------------------- Boolean Arguments
   ...
   //
class CmdLineExport CmdArgBoolCompiler : public CmdArg {
public:
   ...
   //
class CmdLineExport CmdArgBool : public CmdArgBoolCompiler {
public:
...
class CmdLineExport CmdArgClear : public CmdArgBool {
public:
...
class CmdLineExport CmdArgToggle : public CmdArgBool {
public:
   ...
   //    cout << "xmode is " << (xflag ? "ON" : "OFF") << endl ;
   //
class CmdLineExport CmdArgBoolRef : public CmdArg {
public:
...
class CmdLineExport CmdArgClearRef : public CmdArg {
public:
...
class CmdLineExport CmdArgToggleRef : public CmdArg {
public:
