...
#  define cmdlineexport
  ...
  //
  // Changed by IS 27/03/2001 for SunPro CC 5.1 porting
  //
...
typedef std::ostream& ostreamCmdlRef;
...
//-----------------------------------------------------------------------------
   ...
   //
class CmdLineExport CmdLineArgIter {
public:
   CmdLineArgIter(void);
...
private:
   ...
   //
class CmdLineExport CmdArgvIter : public CmdLineArgIter {
public:
   CmdArgvIter(int argc, const char * const argv[])
      : index(0), count(argc), array(argv) {}

   CmdArgvIter(const char * const argv[])
      : index(0), count(-1), array(argv) {}
...
private:
   ...
   //
class CmdLineExport CmdStrTokIter : public CmdLineArgIter {
public:
...
private:
   ...
   //
class CmdLineExport CmdIstreamIter : public CmdLineArgIter {
public:
...
inline cmdlineexport  std::ostream &
...
class CmdLineExport CmdLineCmdArgIter {
public:
