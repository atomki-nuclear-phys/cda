...
CmdArgUsage::CmdArgUsage(char         optchar,
                         ...
                         std::ostream    * osp)
   : CmdArg(optchar, keyword, description, (unsigned)CmdArg::isOPT), os_ptr(osp)
{
...
//CmdArgStrList::~CmdArgStrList(void) {}
	...
	// @@ Igor Soloviev 04/02/99
CmdArgStrList::~CmdArgStrList(void) {
   if (val) {
     delete val;
     val = (CmdArgStrListPrivate *)0;
   }
}
