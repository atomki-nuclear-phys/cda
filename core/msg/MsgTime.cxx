...
MsgTime::MsgTime(int hour, int minute, int second, int milisecond)
    : m_date(QDate::currentDate()), m_time(hour, minute, second, milisecond) {}
 ...
 * @param milisecond The mili-second the message was sent
 */
MsgTime::MsgTime(int year, int month, int day, int hour, int minute, int second,
                 int milisecond)
    : m_date(year, month, day), m_time(hour, minute, second, milisecond) {}
