...
#else
   REPORT_VERBOSE(tr("Inhibit set on device: %1").arg(m_devicePath));
#endif  // HAVE_CAMAC_LIB
...
#else
   REPORT_VERBOSE(tr("Inhibit reset on device: %1").arg(m_devicePath));
#endif  // HAVE_CAMAC_LIB
...
#else
   m_logger << msg::DEBUG << tr("Clear called on device: %1").arg(m_devicePath)
            << msg::endmsg;
#endif  // HAVE_CAMAC_LIB
...
#else
   m_logger << msg::DEBUG << tr("LAM cleared on device: %1").arg(m_devicePath)
            << msg::endmsg;
#endif  // HAVE_CAMAC_LIB
