...
public:
   ...
   MDIView(QWidget* parent = 0, Qt::WindowFlags flags = Qt::WindowFlags());
   /// Destructor
   ~MDIView();
...
private:
   ...
   QSplitter*
       m_splitter;  ///< Object holding the two child widgets of this object
   QMdiArea*
       m_mdiArea;  ///< An MDI area showing sub-windows with processing rates
   QTableWidget*
       m_rateTable;  ///< Table giving a quick overview of processing rates

   /// Map associating statistics source IDs with sub-windows showing their
   /// information
