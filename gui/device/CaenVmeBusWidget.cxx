...
CaenVmeBusWidget::CaenVmeBusWidget(QWidget* parent, Qt::WindowFlags flags)
   ...
   m_label.reset(new QLabel(tr("CAEN VME Controller Configuration"), this));
   ...
   connect(m_type.get(), SIGNAL(currentIndexChanged(int)), this,
           SLOT(typeModifiedSlot(int)));
   ...
   connect(m_linkNumber.get(), SIGNAL(valueChanged(int)), this,
           SLOT(linkNumberModifiedSlot(int)));
   ...
   connect(m_boardNumber.get(), SIGNAL(valueChanged(int)), this,
           SLOT(boardNumberModifiedSlot(int)));
   ...
   connect(m_checkDeviceSync.get(), SIGNAL(toggled(bool)), this,
           SLOT(checkDeviceSyncModifiedSlot(bool)));
}
...
void CaenVmeBusWidget::typeModifiedSlot(int index) {
   ...
   caen::VmeBus::BoardType type = static_cast<caen::VmeBus::BoardType>(index);
