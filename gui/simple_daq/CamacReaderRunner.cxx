...
CamacReaderRunner::CamacReaderRunner(QWidget* parent, Qt::WindowFlags flags)
    : QWidget(parent, flags), m_runner(), m_logger("sd::CamacReaderRunner") {
   ...
   //
   m_runner.setExecName(daq::PathResolver::resolve("cda-camac-reader", "PATH"));
   if (m_runner.getExecName() == "") {
      REPORT_ERROR(
          tr("cda-camac-reader not found. Data acquisition "
             "is not possible."));
